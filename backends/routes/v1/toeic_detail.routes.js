...
const controller = require('../../controllers/toeic_detail.controller');
const { response, responseError } = require('../../errors');
logger.info('toeic_detail.routes loaded');

router.get('', async (req,res) => {
  try {
    logger.info('toeic_detail.routes get ');
...
router.post('', async (req,res) => {
  try {
    logger.info('toeic_detail.routes /post ');
...
router.patch('', async (req,res) => {
  try {
    logger.info('toeic_detail.routes /update ');
...
router.delete('', async (req,res) => {
  try {
    logger.info('toeic_detail.routes /delete ');
